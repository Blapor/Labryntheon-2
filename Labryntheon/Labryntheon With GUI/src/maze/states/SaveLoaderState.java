...
public class SaveLoaderState extends State{
    ...
    public SaveLoaderState(Main main){
        ...
        save1Button = new Button(Color.darkGray, Color.green,width/3 - 128, height/5, 256,64, "Save 1");
        save2Button = new Button(Color.darkGray, Color.green,width/3 - 128, height*2/5, 256,64, "Save 2");
        ...
        save6Button = new Button(Color.darkGray, Color.green,width*2/3 - 128, height/5, 256,64, "Save 6");
        save7Button = new Button(Color.darkGray, Color.green,width*2/3 - 128, height*2/5, 256,64, "Save 7");
    ...
    public void render(Graphics g) {
        ...
        g.drawString("Choose Save to Load", (width/2) - (g.getFontMetrics().stringWidth("Choose Save to Load") / 2), (height/4) - 32);
        
        g.setFont(new Font("Comic Sans MS", Font.BOLD, 12));
        g.setColor(Color.white);
        g.drawString(save1Button.getText(), (width/2) - (g.getFontMetrics().stringWidth(save1Button.getText()) / 2), (height/3 + 32));
        g.drawString(save2Button.getText(), (width/2) - (g.getFontMetrics().stringWidth(save2Button.getText()) / 2), (height/3 + 32));
        g.drawString(save3Button.getText(), (width/2) - (g.getFontMetrics().stringWidth(save3Button.getText()) / 2), (height/3 + 32));
        g.drawString(save4Button.getText(), (width/2) - (g.getFontMetrics().stringWidth(save4Button.getText()) / 2), (height/3 + 32));
        g.drawString(save5Button.getText(), (width/2) - (g.getFontMetrics().stringWidth(save5Button.getText()) / 2), (height/3 + 32));
        g.drawString(save6Button.getText(), (width/2) - (g.getFontMetrics().stringWidth(save6Button.getText()) / 2), (height/3 + 32));
        g.drawString(save7Button.getText(), (width/2) - (g.getFontMetrics().stringWidth(save7Button.getText()) / 2), (height/3 + 32));
        g.drawString(save8Button.getText(), (width/2) - (g.getFontMetrics().stringWidth(save8Button.getText()) / 2), (height/3 + 32));
        g.drawString(save9Button.getText(), (width/2) - (g.getFontMetrics().stringWidth(save9Button.getText()) / 2), (height/3 + 32));
        g.drawString(save10Button.getText(), (width/2) - (g.getFontMetrics().stringWidth(save10Button.getText()) / 2), (height/3 + 32));
        g.drawString(backButton.getText(), (width/2) - (g.getFontMetrics().stringWidth(backButton.getText()) / 2), (height/2 + 32));
